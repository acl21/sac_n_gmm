...
#SBATCH --job-name EvalSkillDS             # short: -J <job name>
...
python examples/CALVINExperiment/evaluate_skills_ds.py --state-type pos
python examples/CALVINExperiment/evaluate_skills_ds.py --state-type joint
