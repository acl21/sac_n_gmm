...
class CALVINTaskDataset(Dataset):
    def __init__(self, task, train=True, state_type='pos',
                 demos_dir='', dt=2/30, sampling_dt=1/30):
        self.task = task
        ...
        if self.train:
            ...
            fname = 'validation'
        self.data_file = glob.glob(os.path.join(self.demos_dir, self.task_name, f'{fname}.npy'))[0]
